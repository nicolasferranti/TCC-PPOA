...
public class Gerador {
	...
	public List<Cromossomo> criaPopulacao(int qtd, ArrayPesosGranulares pesos) {
        ...
        /**
         * Esse método retorna o caminho para cada nó da estrutura de funções.
         * O caminho é denotado por uma sequência, onde cada algarismo significa a posição do filho no nível. A abordagem é parecida com um caminhamento digital na árvore.
         * @param raiz
         * @param alt
         * @param niveis
         */
