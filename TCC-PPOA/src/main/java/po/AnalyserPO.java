...
import similarity.MainContainer;
...
public class AnalyserPO {
    ...
    public TabelaSimilaridade process() throws Exception {
        ...
        if (xml.callAG()) {
            ...
            new PPConectorPO(file.getAbsolutePath(), conceitos1, conceitos2).setPesosToContainer(mainContainer);
        }
