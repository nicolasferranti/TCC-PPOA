...
public class PPConectorPO {
    ...
    public PPConectorPO(String filePath, List<OntResource> conceitosOnto1, List<OntResource> conceitosOnto2) {
    ...
    private void runAG(double[] resultadoDasEquacoes) throws IOException {
        PresaPredadorPO pp;
        pp = new PresaPredadorPO(new GeradorPO(equacoes, resultadoDasEquacoes), 10, 0.005);
        pp.SimulaVida();
        System.exit(0);
